    ...
    <div className="flex flex-col  absolute top-[6.5rem] right-[6.75%] w-[15rem] p-4 bg-[#B8D8FF] rounded-xl before:absolute before:top-[-0.5rem] before:right-[1.25rem] before:w-[25px] before:h-[25px] before:bg-[#B8D8FF] before:rotate-45 before: before: before: before: before: before:">
      <ul>
        <li className="flex justify-center pb-4 pt-2  ">
          <Link to={'/institute-detail'}><button className="text-[#00227A] text-base font-[400] font-[Noto Sans] leading-6">
            Institute Details
          </button></Link>
        </li>
        <li className="flex justify-center py-4  text-[#00227A] text-base font-[400] font-[Noto Sans] leading-6">
          <Link to={'/institute-student'}><button className="text-[#00227A] text-base font-[400] font-[Noto Sans] leading-6">
            Verify/Register Students
          </button></Link>
        </li>
        <li className="flex justify-center py-4  text-[#00227A] text-base font-[400] font-[Noto Sans] leading-6">
          <Link to={'/institute-student/result'}><button className="text-[#00227A] text-base font-[400] font-[Noto Sans] leading-6">
            Publish Results
          </button></Link>
        </li>
        <li className="flex justify-center py-4  text-[#00227A] text-base font-[400] font-[Noto Sans] leading-6">
          <Link><button className="text-[#00227A] text-base font-[400] font-[Noto Sans] leading-6">
