...
const InstituteNotifDropdown = ({ open }) => {
  if (!open) return null;
  return (
    <div className="flex flex-col  absolute top-[5.75rem] right-[10.5%]  w-[294px] p-4 bg-[#B8D8FF] rounded-xl before:absolute before:top-[-0.5rem] before:right-[1.25rem] before:w-[25px] before:h-[25px] before:bg-[#B8D8FF] before:rotate-45 before: before: before: before: before: before:">
      <ul>
