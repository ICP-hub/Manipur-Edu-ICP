...
const UploadResult = ({ open, onClose }) => {
  if (!open) return null;
  return (
    <div className="shadow-lg mt-10 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#EEF6FF] h-[32.5rem]  w-[70%] rounded-xl ">
      <div className="shadow-lg flex flex-col px-[3.125rem] py-[2.5rem]">
