...
const ProfileTab = () => {
  ...
  return (
    <div>
      {view === "editProfile" ? (
        <EditProfile onBack={() => SetView("default")} />
      ) : (
        <div className="py-[25px] px-[63px]">
          <div className="flex flex-col ">
            ...
            <div className="flex flex-col mt-[50px]">
              <div className="flex px-[2.875rem] py-[1rem] border border-[#BED0FF] rounded-[1.25rem] mb-[1.6875rem]">
              ...
              <div className="flex flex-col border border-[#BED0FF] rounded-[1.25rem] mb-[1.6875rem]">
                <div className="border-b border-[#BED0FF]">
                  <div className="flex justify-between px-[2.875rem] py-[0.75rem]">
              ...
              <div className="flex flex-row-reverse pt-[0.75rem] pb-[1.25rem]">
                <button
                  onClick={() => SetView("editProfile")}
                  className="px-[2.75rem] py-[1rem] border bg-[#0041E9] text-[white] rounded-[0.625rem]"
                >
                  Edit
                </button>
              </div>
