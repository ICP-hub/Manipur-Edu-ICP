    ...
    return (
        <div className="py-[25px] px-[63px]">
            <div className="flex flex-col ">
                ...
                <div className="flex flex-col border border-[#BED0FF] rounded-[20px] mt-[20px] xl:mt-[30px] ">
                    <div className="flex px-[2.875rem] py-[1rem] border-b border-[#BED0FF] mb-[0.75rem] xl:mb-[1.6875rem]">
                    ...
                    <div className="flex flex-col mb-[1rem] xl:mb-[1.6875rem]">
                        <div className="flex justify-between px-[2.875rem] pt-[0.2rem] pb-[25px]">
                            <p className="font-[Noto Sans] text-[#00227A] text-[24px] leading-[1.5rem] font-[400] pl-[10px]">
                                Details
                            </p>
                        </div>
                        <form action="">
                            <div class="flex justify-between pl-[3.4375rem] pr-[1.5625rem] pb-[1.25rem]">
                                <div class="w-full">
                                    <label
                                ...
                                <div class="w-full">
                                    ...
                                    <br />
                                    <input
                                        className="border border-[#CCD9FA] rounded-[0.625rem] w-[90%] h-[3.5rem] mt-[0.5rem] pl-[0.625rem] pr-[0.625rem] focus:outline-none "
                                        type="date"
                                        id="dob"
                                        name="dob"
                                    />
                            ...
                            <div class="flex flex-row-reverse pr-[1.875rem] pb-[0.25rem] text-[1.125rem] pl-[3.75rem]">
