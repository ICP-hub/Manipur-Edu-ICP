...
const ScholarshipApplicationsTab = ({ onTap }) => {
    ...
    return (
        <div>
            <div className="w-full self-center border rounded-[10px] border-[#D9EBFF]">
                <div className=" flex justify-center grid grid-cols-5 py-3 font-semibold px-5 font-[Segoe UI] text-[15px] text-[#00227A] leading-[15px]">
