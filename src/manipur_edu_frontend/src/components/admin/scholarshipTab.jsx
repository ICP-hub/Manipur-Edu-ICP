...
import ScholarshipApplication from "../../pages/Admin/scholarshipApplication";
import ScholarshipDetails from "../../pages/Admin/scholarshipDetails";
import ScholarshipApplicants from "../../pages/Admin/scholarshipApplicants";
import PostScholarshipDetails from "../../pages/Admin/postScholarshipDetails";
import ScholarshipApplicationsTab from "../../pages/Admin/scholarshipApplicationsTab";
import OngoingScholarshipsTab from "../../pages/Admin/ongoingScholarshipsTab";
import ScholarshipPostedAdmin from "../../pages/Admin/scholarshipPostedAdmin";
  ...
  return (
    <div>
      {view === "scholarshipApplication" ? (
        ...
        <PostScholarshipDetails onBack={() => SelectView("default")} />
      ) : (
        <div className="px-[63px] py-[25px] flex flex-col gap-[25px]">
          ...
          <div className="flex gap-[20px]">
            <button
              onClick={() => SetButton("Applications")}
              className={
