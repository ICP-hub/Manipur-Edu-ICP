    ...
    <div className="w-[100vw] flex flex-wrap justify-center items-stretch">
      <div className="sm:flex-col lg1:flex-row flex flex-col w-full max-w-screen-xl xl:mx-auto max-h-[1063px] sm:bg-[#ACBFFD]">
        <div className="flex flex-col justify-center lg1:w-1/2">
          {/* left section */}
          <div className="text-2xl lg1:text-3xl px-5 pt-5 font-bold mb-2 font-[Philosopher] text-[#00227A] sm1:text-[#0041E9] flex lg1:justify-center pb-2 sm1:pb-10">
            Manipur Edu
          </div>
          <div className="lg1:border-b-2 border-[#33286F] flex justify-center w-full">
            <img
              className="h-full object-fill hidden md2:px-[120px] px-[60px] sm1:block relative -bottom-1"
        ...
        {/* right section */}
        <div className="lg1:w-1/2 sm1:h-[100vh] top-[52px] sm1:top-0 sm1:p-10 flex justify-center items-center bg-white relative w-full max-w-screen-xl xl:mx-auto max-h-[1063px]">
