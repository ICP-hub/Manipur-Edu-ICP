    ...
    <div className="py-[25px] px-[63px]">
      <div className="flex flex-col ">
       ...
       <div className="relative">
        ...
        {entry?.[1].status?.[0] === "pending" && <> <button onClick={() => setOpenModalVerify(true)} className="px-[2.75rem] py-[1rem]  text-[white] rounded-[0.625rem] bg-[#0041E9]">
            Verify Institute
          </button>
          <button onClick={() => setOpenModalReject(true)} className="px-[2.75rem] py-[1rem]  text-[white] rounded-[0.625rem] bg-[#DF0C0C]">
            Reject
          </button></>}
          <button
