...
const EditInstituteProfile = ({ onBack }) => {
  return (
      ...
      <div className="flex flex-col ">
        ...
        <div className="flex flex-col border border-[#D8E1F8] rounded-[20px] mt-[25px] xl:mt-[50px] ">
          ...
          <div className="flex flex-col mb-[1rem]  xl:mb-[1.6875rem]">
            <div className="flex justify-between px-[2.875rem] pt-[0.25rem] pb-[20px]">
              <p className="font-[Noto Sans] text-[#00227A] text-[24px] leading-[1.5rem] font-[400]">
                Institute Details
              </p>
            </div>
            <form action="">
              <div class="flex justify-between pl-[3.4375rem] pr-[1.5625rem] pb-[10px] xl:pb-[20px]">
                <div class="w-full">
                  <label
