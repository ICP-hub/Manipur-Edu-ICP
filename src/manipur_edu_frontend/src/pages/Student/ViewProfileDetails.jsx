  ...
  const getImage = async (kyc) => {
    try {
      ...
      for (let i = 0; i < Number(kyc[0].num_chunks); i++) {
        ...
        console.log(
          "kyc[0].image_id is  in for  ",
          kyc[0].image_id,
          typeof kyc[0].image_id
        );
      ...
      let totalLength = newChunks.reduce(
        (acc, val) => (val ? acc + val.length : acc),
        0
      );
              ...
              <div className="  flex flex-col rounded-[20px] border border-[#D8E1F8]">
                ...
                <div className="flex py-[30px] px-[46px] gap-[76px]">
                  <div>
                    ...
                    <button
                      className="rounded-[5px] py-[14px] px-[36px] border border-[#00227A] text-[#00227A] text-[16px] font-[500] text-[Noto Sans]"
                      onClick={handleKyc}
                    >
                      Aadhaar Card
                    </button>
