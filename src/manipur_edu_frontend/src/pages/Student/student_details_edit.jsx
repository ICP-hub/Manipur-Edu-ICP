...
import StudentPersonalDetailsEdit from "./personal_details";
import ParentDetailsEdit from "./parents_details";
import InstituteDetailsEdit from "./student_institute_details";
