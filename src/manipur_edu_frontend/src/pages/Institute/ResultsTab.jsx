    ...
    <div className="w-[85%] self-center  pt-[27px]">
      ...
      {entries?.map(({ studentId, details }, index) => (
        <Card
          ...
          setuploadresultpopup={setuploadresultpopup}
        />
      ))}
...
const Card = ({ studentPrincipalId, entry, seteditresultpopup, setPublicKey, setPrincipalId , setuploadresultpopup}) => {
