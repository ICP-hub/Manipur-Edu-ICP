...
pub struct CanisterSettings {
    ...
    //no. of instruction canister can perform per sec
    pub compute_allocation: Option<Nat>,
    //the maximum amount of memory the canister can use
    pub memory_allocation: Option<Nat>,
    //the amount of cycles the canister must have to be considered "non-empty"
    pub freezing_threshold: Option<Nat>,
    // the limit on the number of cycles that can be reserved by the canister
